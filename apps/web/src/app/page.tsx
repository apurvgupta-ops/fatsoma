        ...
        <div className="relative mx-auto max-w-7xl px-4 pb-20 pt-12 sm:px-6 lg:px-8">
          <div className="space-y-10">
            ...
            {loading ? (
              ...
              <div className="flex min-h-60 items-center justify-center rounded-3xl border border-border bg-void/60">
            ...
            <footer className="border-t border-border pt-6 text-center text-xs text-cream/60">
