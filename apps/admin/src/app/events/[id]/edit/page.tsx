      ...
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-4 pb-16 pt-12 sm:px-6 lg:px-8">
        ...
        <header className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link
              href="/events"
              className="flex h-10 w-10 items-center justify-center rounded-xl border border-border bg-white/5 text-cream/60 transition hover:bg-white/10 hover:text-cream"
            >
        ...
        <Section title="Ticket Batches" icon={<Ticket className="h-5 w-5" />}>
          <div className="flex flex-col gap-4">
            ...
            <button
              type="button"
              onClick={addBatch}
              className="flex items-center gap-2 self-start rounded-xl border border-dashed border-border bg-white/5 px-4 py-2.5 text-sm font-medium text-cream/60 transition hover:border-gold/40 hover:text-gold"
            >
        ...
        >
          <div className="grid gap-5 md:grid-cols-2">
            <InputField
              ...
              required
            />
            <div className="flex items-center gap-2 rounded-xl border border-border bg-white/5 px-4 py-3">
          ...
          {showDeleteConfirm ? (
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="rounded-xl border border-border px-4 py-2 text-sm text-cream/60 transition hover:bg-white/5"
              >
                Cancel
              </button>
            </div>
        ...
        <div className="flex flex-col gap-3 border-t border-border pt-6 sm:flex-row sm:justify-end">
          <button
            ...
            disabled={saving}
            className="rounded-xl border border-border bg-white/5 px-6 py-3 text-sm font-semibold text-cream/90 transition hover:bg-white/10 disabled:opacity-50"
          >
