          ...
          <header className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              ...
              <div className="flex gap-3">
                ...
                <button className="rounded-xl bg-gradient-to-r from-indigo-500 via-purple-500 to-blue-500 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-purple-500/30 transition hover:brightness-110">
                  Share
                </button>
              </div>
            </div>
              ...
              <div className="sticky top-6 space-y-6">
                <section className="rounded-3xl border border-white/10 bg-zinc-950/70 p-5 shadow-[0_20px_60px_rgba(0,0,0,0.35)]">
                  ...
                  <div className="mt-4 space-y-4">
                    ...
                    <div className="rounded-xl border border-white/10 bg-gradient-to-br from-zinc-950 via-zinc-950 to-purple-950/40 p-4">
                      <p className="text-xs uppercase tracking-[0.2em] text-zinc-500">
                        Revenue Range
                      </p>
